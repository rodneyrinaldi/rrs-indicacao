  ...
  return (
    <main className="auth-shell">
      <section className="auth-card">
        <p className="eyebrow">Acesso do agente</p>
        <h1 className="title-lg">Login do agente</h1>
        <p className="body-muted">Entre com celular e senha para acessar o painel.</p>

        <form action={loginAgent} className="form-stack">
